...
const integrations = [
  ...
  { name: "HubSpot", category: "Product" },
  { name: "Zapier", category: "Flow" },
  { name: "Snowflake", category: "Data" },
  { name: "Stripe", category: "Web3" },
];
...
export function IntegrationsSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Banner image reveal
      gsap.fromTo(
        ".integrations-banner-reveal img",
        { scale: 1.06, opacity: 0 },
        {
          scrollTrigger: {
            trigger: ".integrations-banner-reveal",
            start: "top 85%",
            toggleActions: "play reverse play reverse",
          },
          scale: 1,
      ...
      gsap.fromTo(
        ...
        {
          scrollTrigger: {
            trigger: ".integrations-grid-container",
            start: "top 85%",
            toggleActions: "play reverse play reverse",
          },
          opacity: 1,
      ...
      // Bottom stats reveal
      gsap.fromTo(
        ".integrations-footer-stats",
        { opacity: 0, y: 30 },
        {
          scrollTrigger: {
            trigger: ".integrations-footer-stats",
            start: "top 90%",
            toggleActions: "play reverse play reverse",
          },
          opacity: 1,
  ...
  return (
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center integrations-header">
        <span className="inline-flex items-center gap-4 text-sm font-mono text-muted-foreground mb-8 justify-center">
        ...
        <p className="mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto">
          Developing with industry-standard language structures, Web3 blockchains, and AI agent frameworks to build secure and scalable platforms.
        </p>
      </div>

      {/* Full-width image */}
      <div className="relative left-1/2 -translate-x-1/2 w-screen -mt-16 integrations-banner-reveal">
        <img
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-16 integrations-grid-container">
          {integrations.map((integration, index) => (
            <div
              key={integration.name}
              className={`group relative overflow-hidden p-6 lg:p-8 border transition-all duration-500 cursor-default integrations-grid-item ${
                hoveredIndex === index
        ...
        {/* Bottom stats row */}
        <div className="flex flex-wrap items-center justify-between gap-8 pt-12 border-t border-foreground/10 pb-32 lg:pb-40 integrations-footer-stats">
